package ru.mirea.velikanov.audiorecapp;
...
// проверка наличия разрешений на выполнение аудиозаписи и сохранения на карту памяти
        ...
        playRecordButton = findViewById(R.id.btnPlay);
    }
...
//            processAudioFile();
    ...
    private void startRecording() throws IOException {
        ...
        if (Environment.MEDIA_MOUNTED.equals(state) ||
            ...
            if (audioFile == null) {
                // создание файла
                audioFile = new File(this.getExternalFilesDir(Environment.DIRECTORY_MUSIC), "mirea.3gpp");
            }
            Toast toast = Toast.makeText(this, audioFile.getAbsolutePath(),Toast.LENGTH_LONG);
            toast.show();
